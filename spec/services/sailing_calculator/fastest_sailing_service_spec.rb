...
RSpec.describe SailingCalculator::FastestSailingService do
    ...
    let(:result) do
      [
        ...
        },
        {
          ...
          destination_port: santos_port.code,
          departure_date: another_sailing_option_from_barcelona.departure_date.to_s,
          arrival_date: another_sailing_option_from_barcelona.arrival_date.to_s,
        ...
        {
          origin_port: santos_port.code,
          destination_port: destination_port.code,
          departure_date: sailing_option_from_santos.departure_date.to_s,
          arrival_date: sailing_option_from_santos.arrival_date.to_s,
          sailing_code: barcelona_sailing_rate.sailing_code,
          rate: barcelona_sailing_rate.rate,
          rate_currency: barcelona_sailing_rate.currency_code
        }
